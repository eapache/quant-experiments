...
class FrozenHybridSamplerDocumentsTest(unittest.TestCase):
    def test_report_includes_document_level_summary(self) -> None:
        row = {
            "document": "code-a", "q2_js": 0.052, "baseline_js": 0.05,
            "corrected_js": 0.049, "model_js_recovery": 0.038,
            "js_recovery": 0.02, "total_js_recovery": 0.058,
            "improved_chunks": 20, "chunks": 32,
        ...
        aggregate = {
            ...
            "pooled_model_js_recovery": 0.038, "pooled_js_recovery": 0.02,
            "pooled_total_js_recovery": 0.058,
            "mean_document_js_reduction": 0.001,
